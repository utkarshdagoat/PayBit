...
_export(exports, {
    CreateKYCDto: function() {
        return CreateKYCDto;
    },
    CreateKYCPayload: function() {
        return CreateKYCPayload;
    }
});
...
let CreateKYCPayload = class CreateKYCPayload {
    constructor(){
...
_ts_decorate([
    (0, _classvalidator.IsNotEmpty)(),
    _ts_metadata("design:type", typeof CreateKYCDto === "undefined" ? Object : CreateKYCDto)
