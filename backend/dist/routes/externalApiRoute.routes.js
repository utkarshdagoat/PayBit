...
let ExternalAPIRouter = class ExternalAPIRouter {
    initializeRoutes() {
        ...
        this.router.get(`${this.path}/get-data`, _tokenmiddleware.TokenSessionMiddleWare, this.externalApiController.getDataFromToken);
        this.router.post(`${this.path}/transfer-funds-testnet`, _signverifymiddleware.SignVerifyMiddleware, this.externalApiController.transferFundsTestnet);
        this.router.post(`${this.path}/transfer-funds-mainnet`, _signverifymiddleware.SignVerifyMiddleware, this.externalApiController.transferFundsMainnet);
    }
    constructor(){
