...
let KYCRoutes = class KYCRoutes {
    initializeRoutes() {
        this.router.post(`${this.path}/create`, (0, _validationmiddleware.ValidationMiddleware)(_kycdto.CreateKYCPayload), this.dashboardController.createKYC);
        this.router.get(`${this.path}/status`, _authmiddleware.AuthMiddleware, this.dashboardController.getKYC);
