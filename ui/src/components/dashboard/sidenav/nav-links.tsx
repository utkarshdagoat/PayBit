          ...
          <>
            {state.component ? (
              <Button
                ...
                className={clsx(
                  "flex h-[48px] grow items-center justify-center transition-all duration-200 gap-2 rounded-md bg-accent p-3 text-sm font-semibold hover:bg-accent/80 hover:text-accent-foreground hover:shadow-2xl text-muted-foreground md:flex-none md:justify-start md:p-2 md:px-3",
                  {
