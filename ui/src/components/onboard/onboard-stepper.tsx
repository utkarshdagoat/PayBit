...
export default function OnboardStepper() {
  ...
  const stepMetadata = [
    { label: "Welcome to PayBit!", img: signupImg },
  ...
  return (
    <div className="flex w-full h-screen gap-4">
      <div className="w-[40%] flex items-center flex-col bg-black/90 justify-center">
        ...
        >
          ...
          {hasCompletedAllSteps && (
            <Card className="bg-background w-[64%] h-[20rem] border-none">
              <CardHeader>
                <CardTitle>You are now ready to use PayBit!</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">
                  You have completed all the steps required to use PayBit. Now
