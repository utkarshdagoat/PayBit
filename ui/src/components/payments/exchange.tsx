  ...
  return (
    <>
      {paymentClickedStripe ? (
        ...
        <div
          className={`p-1 bg-gradient-to-br w-[400px] from-gradient_1/0 via-primary/80 to-gradient_2/0 ${styles.animate_gradient} rounded-xl`}
        >
            ...
            {!paymentClickedLoading ? (
              <>
                <CardHeader>
                  <CardTitle>
                    Get{" "}
                    <span className="text-primary font-extrabold">UBIT</span>{" "}
                    Tokens
                  </CardTitle>
